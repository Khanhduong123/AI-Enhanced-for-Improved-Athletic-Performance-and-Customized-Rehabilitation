...
def json_to_numpy(json_file, class_name, max_frames=None):
...
class KeypointDataset(Dataset):
    def __init__(self, json_folder, max_frames=500):
        self.data = []
        self.labels = []
        ...
        for class_name in class_folders:
            ...
            for json_file in json_files:
                ...
                if keypoints is not None:
                    ...
                    padded_keypoints = np.zeros((self.max_frames, 33, 2), dtype=np.float32)
...
if __name__ =="__main__":
    ...
    for batch in dataloader:
        ...
        print("X_batch shape:", X_batch.shape)  # (batch_size, max_frames, 33, 2)
